...
export const fpv = {
    ...
    box: {
        ...
        item: {
            ...
            2: {
                name: 'Spare EFPV XS-U7 Control Sticks (Pair)',
                src: '',
            },
            3: {
                name: 'EFPV XS-U7 Cable (Lightning Connector)', 
                src: '',
            },
            4: {
                name: 'EFPV Eagle 5 Intelligent Flight Battery',
                src: '',
            },
            5: {
                name: 'EFPV 65W Portable Charger',
                src: '',
            },
            6: {
                name: 'EFPV XS-U7 Remote Controller',
                src: '',
            },
            7: {
                name: 'EFPV XS-U7 Cable (USB-C Connector)',
                src: '',
            },
            8: {
                name: 'EFPV XS-U7 Cable (Standard Micro-USB Connector)',
                src: '',
            },
            9: {
                name: 'EFPV Eagle 5 Low-Noise Propellers (pair)',
                src: '',
            },
            10: {
                name: 'EFPV Eagle 5 Storage Cover',
                src: '',
            },
        },
    },
