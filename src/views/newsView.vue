        ...
        <div class="banner_word">
          ...
          <div class="banner_txt">
            <p>
              ...
              Obcaecati, enim debitis nesciunt eligendi recusandae porro.
            </p>
          </div>
          <!-- btn 等勝翔上傳簡單版的btn 再引用 -->
        </div>
        <div class="banner_right_txt">
          <p>Travel the world with a drone</p>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="content" v-show="isActive('tab-1')">
        <div class="card">
          <router-link class="anchor" to="/"
            ><img src="../assets/images/About/img_07.jpg" alt="img"
          /></router-link>
          <div class="item_box">
            <div class="item">Game</div>
          </div>
          <p>8th style free</p>
          <router-link class="article" to="/"
            ><button>Remove &rarr;</button></router-link
          >
        </div>
        <div class="card">
          <router-link class="anchor" to="/"
  ...
  <section class="label">
    <div class="customed_content_box cards">
      <div class="content" v-show="isActive('tab-2')">
        <div class="card">
          <router-link class="anchor" to="/"
            ><img src="../assets/images/About/img_02.jpg" alt="img"
          /></router-link>
          <div class="item_box">
            <div class="item">Customed</div>
          </div>
          <p>8th style free</p>
          <router-link class="article" to="/"
            ><button>Remove &rarr;</button></router-link
  ...
  <section class="label">
    <div class="output_content_box cards">
      <div class="content" v-show="isActive('tab-3')">
        <div class="card">
          <router-link class="anchor" to="/"
            ><img src="../assets/images/About/img_01.jpg" alt="img"
          /></router-link>
          <div class="item_box">
  ...
  <section class="label">
    <div class="photoshot_content_box cards">
      <div class="content" v-show="isActive('tab-4')">
        <div class="card">
          <router-link class="anchor" to="/"
            ><img src="../assets/images/About/img_12.jpg" alt="img"
          /></router-link>
          <div class="item_box">
            <div class="item">Photoshot</div>
          </div>
...
@keyframes animate {
  ...
  100% {
    ...
    text-shadow: 0 0 10px $blue, 0 0 40px $blue, 0 0 80px $blue, 0 0 160px $blue;
  }
}
@keyframes animate-s {
  0% {
