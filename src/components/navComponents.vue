    ...
    <div class="header">
      <div class="logo">
        <router-link class="header-link" to="/home">
          <img src="@/dist/assests/g5_logo_EFVP_Horz.png" alt="LOGO">
        </router-link>
      </div>
      ...
      <div class="wrapper">
        <ul>
          <li v-for="(item, index) in mainMenu" :key="index">
            <router-link class="navHover" :to="`/${item.id}`">{{
              item.name
            }}</router-link>
          </li>
          <div class="icon-wrap">
            ...
            <li>
              <router-link to="/cart" class="shop"
                >
                <img src="@/dist/assests/icon2.png" alt="CART">
              </router-link>
            </li>
          </div>
        </ul>
    ...
    @include l($l-breakpoint) {
      ...
      .shop {
        ...
        img {
          ...
          padding: 10px;
          &:hover {
            filter: invert(50%) sepia(51%) saturate(7497%) hue-rotate(194deg)
