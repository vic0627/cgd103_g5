    ...
    <section class="wrapper">
        <div class="project-list">
            ...
            <div class="project p-1">
                <div class="project-title"><h3>SkyPixel 8th</h3></div>
                <div class="project-categ"><p>2022/11/27</p></div>
                <div class="slide">
                    ...
                    <div class="slide-wrap">
                        ...
                        <div class="slide-pic">
                            <img src="../assets/images/home/news_01.jpg" alt="new01" class="panel__img">
                        </div>
                    </div>
                    </router-link>
                </div>
            ...
            <div class="project p-2">
                <div class="project-title"><h3>Fjallraven</h3></div>
                <div class="project-categ"><p>2022/09/18</p></div>
                <div class="slide1">
                    <router-link to="/articleView">
                    <div class="slide-wrap">
                        <div class="slide-txt">
                        ...
                        <div class="slide-pic">
                            <img src="../assets/images/home/news_02.jpg" alt="new02" class="panel__img">
                        </div>
                    </div>
                    </router-link>
                </div>
            ...
            <div class="project p-3">
                <div class="project-title"><h3>Mens Casual</h3></div>
                <div class="project-categ"><p>2022/08/12</p></div>
                <div class="slide2">
                    <router-link to="/articleView">
                    <div class="slide-wrap">
                        <div class="slide-txt">
                        ...
                        <div class="slide-pic">
                            <img src="../assets/images/home/news_03.jpg" alt="new03" class="panel__img">
                        </div>
                    </div>
                    </router-link>
                </div>
            ...
            <div class="project p-4">
                <div class="project-title"><h3>Peak District</h3></div>
                <div class="project-categ"><p>2022/07/23</p></div>
                <div class="slide3">
                    <router-link to="/articleView">
                    <div class="slide-wrap">
                        <div class="slide-txt">
                        ...
                        <div class="slide-pic">
                            <img src="../assets/images/home/dji4.jpg" alt="new04" class="panel__img">
                        </div>
                    </div>
                    </router-link>
                </div>
